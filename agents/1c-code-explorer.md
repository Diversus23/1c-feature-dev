...
description: "Глубокий анализ существующих доработок 1C: трассировка путей выполнения, отображение слоёв архитектуры, понимание паттернов и абстракций, документирование зависимостей для информирования новой разработки. Используй проактивно для глубокого анализа кодовой базы перед доработками."
model: opus
color: blue
---
