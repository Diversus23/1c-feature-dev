...
Подробности в `mcp-requirements.md`.

### Опциональные

- **Поиск метаданных** — для поиска объектов конфигурации, модулей БСП, зависимостей между объектами. Улучшает полноту анализа, но агент может работать и без MCP, опираясь на файлы проекта
- **Контекст платформы** — для проверки методов и свойств платформы при трассировке кода
