...
4. **Изучи через MCP** объекты метаданных, с которыми предстоит работать:
...
5. Спроектируй решение, учитывая SOLID, DRY и правила из 1c-rules.md
6. Напиши код, строго следуя каждому правилу из 1c-rules.md
7. **Проверь код через MCP**:
...
8. Проведи внутреннее ревью кода по правилам из 1c-rules.md
9. При необходимости улучши код
10. Представь результат с кратким объяснением ключевых решений
