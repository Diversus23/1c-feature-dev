...
- **Поиск метаданных** — для анализа существующих объектов конфигурации, модулей БСП, поиска похожих доработок. Улучшает качество архитектурных решений
- **Контекст платформы** — для проверки доступных методов и типов платформы при проектировании
