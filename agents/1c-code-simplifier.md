...
- **Контекст платформы** — для проверки имен переменных на конфликт с глобальным контекстом 1С (Документы, Справочники, Регистры, Метаданные и др.)
- **Поиск метаданных** — для поиска существующих методов общих модулей, которые можно переиспользовать вместо дублирования
