...
flowchart TD
    ...
    P1["1. Discovery Уточнение задачи"]
    P1 -->|"✅ Задача понятна"| P2

    P2["2. Исследование 3× 1c-code-explorer ⚡"]
    P2 --> P3

    P3["3. Уточняющие вопросы"]
    P3 -->|"✅ Ответы получены"| P4

    P4["4. Архитектура 3 × 1c-code-architect ⚡"]
    ...
    P6["6. Проверка качества 3 × 1c-code-reviewer ⚡"]
    P6 -->|"Найдены проблемы → исправить сейчас"| FIX
